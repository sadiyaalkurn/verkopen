...
/**
 * This is the model class for table "user_nutrition_file_mapping".
 *
 * @property integer $id
 ...
 * @property Files $file
 */
class UserNutritionFileMapping extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'user_nutrition_file_mapping';
    }
